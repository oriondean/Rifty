    ...
    return (
        <div className={clsx(
            ...
            <button
                ...
                className="absolute top-2 right-2 z-20 p-1.5 bg-red-500/80 text-white rounded-full opacity-0 group-hover:opacity-100 transition-opacity hover:bg-red-600"
                title="Remove Card"
            >
